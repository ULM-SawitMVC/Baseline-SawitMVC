...
Usage:
    ...
    python pipeline/run_counting_rf.py --inference-dir predictions/y26m_inference/
    python pipeline/run_counting_rf.py --inference-dir predictions/y26m_inference/ --out benchmarks/e2e/my_result/
"""
