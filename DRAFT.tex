...
avoid double counting~\cite{ref5,ref6,ref2}. Recent plant-phenotyping work has
...
pipelines~\cite{ref8,ref7}. These methods, however, are evaluated mainly on
...
established~\cite{ref1,ref8,ref7}, and YOLO-style single-stage detectors are now
