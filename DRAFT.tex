...
feature ablation, indicates that the current bottleneck is detector quality
rather than tree-level count aggregation.
\end{abstract}
...
\begin{enumerate}
  \item \textbf{A systematic benchmark of tree-level bunch counting under two
    ...
    (upper bound on counter performance) and under cached YOLO26m
...
extractor reads cached YOLO26m~\cite{ref18} predictions. A single
...
counter families when they receive cached YOLO26m outputs. The best F0
...
protocols. Only one detector checkpoint (YOLO26m) is evaluated, and a
...
the fixed YOLO26m detector, the best Ridge + $F_{\text{all}}$ pipeline
...
arXiv:2004.10934, 2020. [Online]. Available:
...
2010, pp.~1324--1332. [Online]. Available:
\url{https://papers.nips.cc/paper_files/paper/2010/hash/fe73f687e5bc5280214e0486b273a5f9-Abstract.html}
